...
| Audit existing translations | `loc_audit_prompt.md` (+ `loc_audit_lang_calibration/<lang>.md` for ar/hi/vi/id/ms/pl; per-language glossary checklist) | `loc_audit_extract.py`, `loc_audit_glossary.py`, `loc_audit_apply.py` |
